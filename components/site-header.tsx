  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-6 px-6">
        <Link href="/" className="flex items-center gap-2.5" aria-label="Subsidy Dropoff, home">
          <CliffMark className="h-6 w-9 shrink-0 text-foreground" />
          <span className="font-serif text-lg tracking-tight sm:text-xl">Subsidy Dropoff</span>
        </Link>
